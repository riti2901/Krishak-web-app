  ...
  return (
    ...
    <div className='mt-5 ml-5'>
        ...
        <label htmlFor='DOB'>DOB<br/></label>
         <input className="w-36 h-8 br-4 bg-slate-200 rounded-md" type="date" name="DOB" id="DOB"/></div>
         <div className='inline-block ml-4'>
         <label htmlFor='yoe'> Years of Experience<br/></label>
         <input className="w-36 h-8 br-4 bg-slate-200 rounded-md ml-3" type="number" name="yoe" id="yoe"/>
         </div>
