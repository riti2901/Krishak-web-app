  ...
  return (
    ...
    <div className='mt-5 ml-5'>
        ...
        <label htmlFor='cd'>Current Designation<br/></label>
         <input className="w-80 h-8 br-4 bg-slate-200 rounded-md" type="text" name="currentDesignation" id="cd"/></div>
         <div className='ml-4 inline-block'>
            <label htmlFor='aoe'>Area of Expertise<br/></label>
            <input className="w-36 h-8 br-4 bg-slate-200 rounded-md ml-1" type="text" name="area of expertise" id="aoe"/>
        </div>
        <div className='ml-4 inline-block'>
            <label htmlFor='yoe'>Years of Experience<br/></label>
            <input className="w-36 h-8 br-4 bg-slate-200 rounded-md ml-3" type="text" name="yoe" id="yoe"/>
        </div>
