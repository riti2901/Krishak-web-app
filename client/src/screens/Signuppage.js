  ...
  return (
    <>
      <div className='Signuppage '>
        ...
        <div className='w-80 h-2/3 bg-white mx-auto my-auto rounded-2xl forms'>
    ...
    <div className='mt-2'>
            ...
            <input className="w-72 h-6 br-4 bg-slate-200 rounded-md" type="text" name="email" id="email"/><br/><br/>
        </div>
        <div>
            <label htmlFor='Phone no.'>Phone no.<br/></label>
            <input className="w-72 h-6 br-4 bg-slate-200 rounded-md" type="tel" name="phn no." id="phn no."/><br/><br/>
        </div>
        <div>
        ...
        <div>
            ...
            <input className="w-72 h-6 br-4 bg-slate-200 rounded-md" type="password" name="password" id="password"/>
        </div>
